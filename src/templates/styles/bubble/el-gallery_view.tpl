		...
		<div id="aThumbRatingLic">		
			<div id="aRating">
				{tooltip name="view-avaliacao" text="Avaliação atual"}
					<img id="aRatingImg" src="styles/{$style|replace:".css":""}/img/star{math equation="round(x)" x=$arquivo.rating|default:"blk"}.png">
				{/tooltip}
			</div>
			<div id="aThumbLic">
				<div id="aLic">
				...
				{else}
					<img id="thumbnail" src="styles/{$style|replace:".css":""}/img/iThumb{$arquivo.tipo}.png" height="100" width="100">
				{/if}
