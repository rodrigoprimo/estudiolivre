...
<div id="listLastChanges">
	<h1>
		...
		{else} 
			{tr}Last Changes{/tr} &nbsp;&nbsp;&nbsp; <a href="tiki-wiki_rss.php?ver=2"><img src="styles/{$prefs.style|replace:".css":""}/img/iRss.png"></a>
		{/if}
	</h1>
	
	<h5>
		{tr}Busca{/tr} <img class="pointer" onclick="javascript:flip('lastChangesOptions');toggleImage(this,'iArrowGreyDown.png')" src="styles/{$prefs.style|replace:".css":""}/img/iArrowGreyLeft.png">
			...
			<tr>
				...
				<td class="heading">
					<a class="tableheading" href="tiki-lastchanges.php?days={$days}&amp;offset={$offset}&amp;sort_mode={if $sort_mode eq 'pageName_desc'}pageName_asc{else}pageName_desc{/if}">
						<img src="styles/{$prefs.style|replace:".css":""}/img/sort{if $sort_mode eq 'pageName_desc'}ArrowUp{elseif $sort_mode eq 'pageName_asc'}ArrowDown{else}GreyArrowDown{/if}.png">
					</a>{tr}Page{/tr}
				</td>
				{*
				<td class="heading">
					<a class="tableheading" href="tiki-lastchanges.php?days={$days}&amp;offset={$offset}&amp;sort_mode={if $sort_mode eq 'action_desc'} action_asc{else}action_desc{/if}">
						<img src="styles/{$prefs.style|replace:".css":""}/img/sort{if $sort_mode eq 'action_desc'}ArrowUp{elseif $sort_mode eq 'action_asc'}ArrowDown{else}GreyArrowDown{/if}.png">
					</a>{tr}Action{/tr}
				</td>
				*}
				<td class="heading">
					<a class="tableheading" href="tiki-lastchanges.php?days={$days}&amp;offset={$offset}&amp;sort_mode={if $sort_mode eq 'user_desc'}user_asc{else}user_desc{/if}">
						<img src="styles/{$prefs.style|replace:".css":""}/img/sort{if $sort_mode eq 'user_desc'}ArrowUp{elseif $sort_mode eq 'user_asc'}ArrowDown{else}GreyArrowDown{/if}.png">
					</a>{tr}User{/tr}
				</td>
				{*
				<td class="heading">
					<a class="tableheading" href="tiki-lastchanges.php?days={$days}&amp;offset={$offset}&amp;sort_mode={if $sort_mode eq 'ip_desc'}ip_asc{else}ip_desc{/if}">
						<img src="styles/{$prefs.style|replace:".css":""}/img/sort{if $sort_mode eq 'ip_desc'}ArrowUp{elseif $sort_mode eq 'ip_asc'}ArrowDown{else}GreyArrowDown{/if}.png">
					</a>{tr}Ip{/tr}
				</td>
				*}
				<td class="heading">
					<a class="tableheading" href="tiki-lastchanges.php?days={$days}&amp;offset={$offset}&amp;sort_mode={if $sort_mode eq 'comment_desc'}comment_asc{else}comment_desc{/if}">
						<img src="styles/{$prefs.style|replace:".css":""}/img/sort{if $sort_mode eq 'comment_desc'}ArrowUp{elseif $sort_mode eq 'comment_asc'}ArrowDown{else}GreyArrowDown{/if}.png">
					</a>{tr}Comment{/tr}
				</td>
			</tr>
