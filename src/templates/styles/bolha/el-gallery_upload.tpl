...
<div id="gUpload">
  ...
  <div id="gUpRight" style="display:none">
	...
	{tr}Licença{/tr}: <span onClick="showLightbox('el-license')" style="cursor: pointer;text-decoration:underline"><img id="uImagemLicenca" src="styles/{$style|replace:".css":""}/img/h_{$licenca.linkImagem}" alt="Escolha uma licença"/></span>
    ...
    <div id="gUpMoreOptions">
      {tooltip text="Clique para definir outras propriedades do arquivo"}
      	<a class="gUpmore pointer" id="gUpmoreoptionsLink" onclick="javascript:flip('gUpMoreOptionsContent'); toggleImage(document.getElementById('moreOptionArrow'),'iArrowGreyDown.png');return false;">{tr}mais opções{/tr} <img id="moreOptionArrow" src="styles/{$style|replace:".css":""}/img/iArrowGreyLeft.png"> </a>{/tooltip}<br/>
