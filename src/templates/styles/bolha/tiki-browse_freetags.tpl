...
<ul class="listFiltersButtons">
	<img id="listFilterImg0" alt="" src="styles/{$prefs.style|replace:".css":""}/img/bLeft{if !$type}Act{else}Inac{/if}.png" />	
	...
	{/tooltip}
	<img id="listFilterImg4" alt="" src="styles/{$prefs.style|replace:".css":""}/img/bRight{if $type eq 'gallery'}Act{else}Inac{/if}.png" />
</ul>
