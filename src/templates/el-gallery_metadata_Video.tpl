...
<div id="aLegenda" class="gUpMoreOptionsItem" style="display:{if $arquivo.legendas}block{else}none{/if};"><div class="gUpMoreOptionsName">Idioma da Legenda:</div> {ajax_input permission=$permission class="gUpMoreOptionsInput" value=$arquivo.idiomaLegenda id="idiomaLegenda" default="" display="inline"}</div>
<br/>
