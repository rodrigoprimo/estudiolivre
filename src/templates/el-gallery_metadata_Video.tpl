...
<div class="gUpMoreOptionsItem"><div class="gUpMoreOptionsName">Idioma do Vídeo:</div> {ajax_input permission=$permission class="gUpMoreOptionsInput" value=$arquivo.idioma id="idioma" default="" display="inline"}</div><br/>
<div class="gUpMoreOptionsItem"><div class="gUpMoreOptionsName" onClick="flip('aLegenda')">{ajax_checkbox permission=$permission class="" id="legendas" value=$arquivo.legendas}</div> Tem legenda</div>
<div id="aLegenda" class="gUpMoreOptionsItem" style="display:none;"><div class="gUpMoreOptionsName">Idioma da Legenda:</div> {ajax_input permission=$permission class="gUpMoreOptionsInput" value=$arquivo.idiomaLegenda id="idiomaLegenda" default="" display="inline"}</div>
<br/>
